...
app.get('/updatetask/:name/:status', function(req,res){
    ...
    // let taskDetails = req.body;
    // let filter = taskDetails.tid;
app.post('/updatetaskpost', function (req, res){
    let obj = {
        name: req.params.name,
        status: req.params.status
    }
    Task.updateMany({'task.fname':'Dave'}, {'task.fname':'Sam' },{ $set: { 'task.fname': 'John' } },{ $set: { 'task.tstatus': 'In Progress' } }, function(err,doc){
